...
RSpec.feature 'User Index', type: :feature do
  ...
  scenario "I can see the user's profile picture." do
    ...
    Post.create(title: 'hey, my post', text: 'Software development is great', author_id: @user2.id)
    within 'form' do
  ...
  scenario " can see a post's title." do
    ...
    find("a[href='#{user_path(@user2.id)}']").click
    find("a[href='#{user_posts_path(@user2.id)}']").click
    expect(page).to have_content 'hey, my post'
  end
  ...
  scenario 'can see the first comments on a post.' do
    ...
    @post = Post.create(title: 'hey, my post', text: 'Software development is great', author_id: @user2.id)
